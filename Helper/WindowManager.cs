...
namespace BahiKitab.Helper
{
    public class WindowManager
    {
        public static Window ChangeWindowContent(Window window, object viewModel, string title, string controlPath)
        {
            ...
            window.Icon = BitmapFrame.Create(new Uri("pack://application:,,,/BahiKitab;component/Resources/Icon.ico", UriKind.RelativeOrAbsolute));

            var controlAssembly = Assembly.Load("BahiKitab");
